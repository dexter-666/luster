...
public class SunnaIcorHelmetModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r2 = helmet_visor.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(120, 42).addBox(-1.5F, -0.075F, -1.5F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 2.75F, 0.0F, -0.7854F, 0.0F));
