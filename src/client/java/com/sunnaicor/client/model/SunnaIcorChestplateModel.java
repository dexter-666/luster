...
public class SunnaIcorChestplateModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition chestplate_body = chestplate.addOrReplaceChild("chestplate_body", CubeListBuilder.create().texOffs(26, 60).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.2575F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition cube_r1 = chestplate_body_plackart_front.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 76).addBox(-5.0F, -2.0F, -2.0F, 10.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.5F, 4.0F, 0.7854F, 0.0F, 0.0F));

		PartDefinition chestplate_body_plackart_front_center = chestplate_body_plackart_front.addOrReplaceChild("chestplate_body_plackart_front_center", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 2.75F, -1.0F, -0.829F, 0.0F, 0.0F));

		PartDefinition chestplate_body_plackart_front_center_x = chestplate_body_plackart_front_center.addOrReplaceChild("chestplate_body_plackart_front_center_x", CubeListBuilder.create().texOffs(42, 109).addBox(-3.0F, -3.0F, 0.0F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(20, 107).addBox(-3.0F, -3.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(120, 46).addBox(-7.0F, -3.0F, 0.0F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(116, 124).addBox(-3.0F, -7.0F, 0.0F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.7854F));
		...
		PartDefinition chestplate_body_plackart_back_center = chestplate_body_plackart_back.addOrReplaceChild("chestplate_body_plackart_back_center", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 6.75F, -2.75F, -0.3054F, 0.0F, 0.0F));

		PartDefinition chestplate_body_plackart_back_center_x = chestplate_body_plackart_back_center.addOrReplaceChild("chestplate_body_plackart_back_center_x", CubeListBuilder.create().texOffs(110, 117).addBox(0.0F, -4.0F, -2.0F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(124, 117).addBox(4.0F, -4.0F, -2.0F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(74, 121).addBox(0.0F, -7.0F, -2.0F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 0.0F, -1.0F, 0.0F, 0.0F, -0.7854F));
		...
		PartDefinition chestplate_body_cape_x = chestplate_body_cape.addOrReplaceChild("chestplate_body_cape_x", CubeListBuilder.create().texOffs(34, 0).addBox(-5.5F, 0.0F, -4.0F, 11.0F, 22.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3927F, 0.0F, 0.0F));

		PartDefinition chestplate_body_cape_left = chestplate_body_cape.addOrReplaceChild("chestplate_body_cape_left", CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, 0.0F, -7.0F, 10.0F, 22.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.0F, -2.0F, -0.5F, 0.2618F, 0.0F, 0.3054F));

		PartDefinition chestplate_body_cape_right = chestplate_body_cape.addOrReplaceChild("chestplate_body_cape_right", CubeListBuilder.create().texOffs(0, 29).addBox(-10.0F, 0.0F, -7.0F, 10.0F, 22.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.0F, -2.0F, -0.5F, 0.2618F, 0.0F, -0.3054F));
		...
		PartDefinition chestplate_body_ornament_left_2 = chestplate_body_ornament_left.addOrReplaceChild("chestplate_body_ornament_left_2", CubeListBuilder.create().texOffs(34, 110).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, -0.3054F, 0.0F, 0.0F));

		PartDefinition chestplate_body_ornament_left_3 = chestplate_body_ornament_left_2.addOrReplaceChild("chestplate_body_ornament_left_3", CubeListBuilder.create().texOffs(16, 93).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 6.0F, 0.0F));
		...
		PartDefinition chestplate_body_ornament_right_2 = chestplate_body_ornament_right.addOrReplaceChild("chestplate_body_ornament_right_2", CubeListBuilder.create().texOffs(126, 110).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, -0.3054F, 0.0F, 0.0F));

		PartDefinition chestplate_body_ornament_right_3 = chestplate_body_ornament_right_2.addOrReplaceChild("chestplate_body_ornament_right_3", CubeListBuilder.create().texOffs(58, 93).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 6.0F, 0.0F));

		PartDefinition legging_body = chestplate_body.addOrReplaceChild("legging_body", CubeListBuilder.create().texOffs(60, 42).addBox(-4.0F, -12.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.255F)), PartPose.offset(0.0F, 12.0F, 0.0F));
		...
		PartDefinition legging_body_tasset_front_x = legging_body_tasset_front.addOrReplaceChild("legging_body_tasset_front_x", CubeListBuilder.create().texOffs(126, 0).addBox(-2.0F, -2.0F, -1.0F, 4.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(110, 0).addBox(-4.0F, -4.0F, -1.0F, 6.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.7854F));
		...
		PartDefinition legging_body_tasset_back_x = legging_body_tasset_back.addOrReplaceChild("legging_body_tasset_back_x", CubeListBuilder.create().texOffs(126, 77).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(110, 109).addBox(-4.0F, -4.0F, -2.0F, 6.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 0.7854F));

		PartDefinition legging_body_tasset_left = legging_body_tassets.addOrReplaceChild("legging_body_tasset_left", CubeListBuilder.create(), PartPose.offsetAndRotation(-5.5F, -2.0F, 0.0F, 0.0F, 0.0F, 0.5672F));
		...
		PartDefinition legging_body_tasset_right = legging_body_tassets.addOrReplaceChild("legging_body_tasset_right", CubeListBuilder.create(), PartPose.offsetAndRotation(5.5F, -2.0F, 0.0F, 0.0F, 0.0F, -0.5672F));
		...
		PartDefinition legging_body_skirt_front = legging_body_skirt.addOrReplaceChild("legging_body_skirt_front", CubeListBuilder.create().texOffs(76, 111).addBox(-2.5F, 0.0F, 0.0F, 5.0F, 8.0F, 2.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(0.0F, -2.0F, -3.0F, -0.5236F, 0.0F, 0.0F));

		PartDefinition cube_r6 = legging_body_skirt_front.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(90, 119).addBox(-2.5F, -2.5F, -1.0F, 5.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 8.5F, 1.0F, 0.0F, 0.0F, 0.7854F));

		PartDefinition legging_body_skirt_back = legging_body_skirt.addOrReplaceChild("legging_body_skirt_back", CubeListBuilder.create().texOffs(112, 77).addBox(-2.5F, 0.0F, -2.0F, 5.0F, 8.0F, 2.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(0.0F, -2.0F, 3.0F, 0.5236F, 0.0F, 0.0F));

		PartDefinition cube_r7 = legging_body_skirt_back.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(16, 120).addBox(-2.5F, -2.5F, -1.0F, 5.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 8.5F, -1.0F, 0.0F, 0.0F, 0.7854F));

		PartDefinition legging_body_skirt_left = legging_body_skirt.addOrReplaceChild("legging_body_skirt_left", CubeListBuilder.create().texOffs(116, 22).addBox(0.0F, 0.0F, -2.0F, 2.0F, 6.0F, 4.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(-5.0F, -2.0F, 0.0F, 0.0F, 0.0F, 0.5236F));

		PartDefinition cube_r8 = legging_body_skirt_left.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(30, 124).addBox(-1.0F, -2.0F, -2.0F, 2.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 6.5F, 0.0F, -0.7854F, 0.0F, 0.0F));

		PartDefinition legging_body_skirt_right = legging_body_skirt.addOrReplaceChild("legging_body_skirt_right", CubeListBuilder.create().texOffs(116, 32).addBox(-2.0F, 0.0F, -2.0F, 2.0F, 6.0F, 4.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(5.0F, -2.0F, 0.0F, 0.0F, 0.0F, -0.5236F));

		PartDefinition cube_r9 = legging_body_skirt_right.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(104, 124).addBox(-1.0F, -2.0F, -2.0F, 2.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 6.5F, 0.0F, -0.7854F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = legging_body_dress.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(58, 106).addBox(0.0F, 14.0F, -2.5F, 4.0F, 3.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(70, 58).addBox(0.0F, 0.0F, -2.5F, 4.0F, 14.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.5F, -3.75F, 0.0F, 0.0F, 0.0F, 0.3927F));

		PartDefinition cube_r11 = legging_body_dress.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(104, 55).addBox(-4.0F, 14.0F, -2.5F, 4.0F, 3.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(66, 17).addBox(-4.0F, 0.0F, -2.5F, 4.0F, 14.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.5F, -3.75F, 0.0F, 0.0F, 0.0F, -0.3927F));
		...
		PartDefinition cube_r12 = legging_body_dress_front.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(88, 63).addBox(-4.75F, 14.0F, -4.0F, 9.0F, 3.0F, 4.0F, new CubeDeformation(0.075F))
		.texOffs(34, 42).addBox(-4.75F, 0.0F, -4.0F, 9.0F, 14.0F, 4.0F, new CubeDeformation(0.075F)), PartPose.offsetAndRotation(0.25F, -3.75F, 2.5F, 0.3927F, 0.0F, 0.0F));

		PartDefinition legging_body_dress_front_left = legging_body_dress_front.addOrReplaceChild("legging_body_dress_front_left", CubeListBuilder.create().texOffs(84, 9).addBox(-4.0F, 0.0F, -4.0F, 4.0F, 14.0F, 4.0F, new CubeDeformation(0.0075F))
		.texOffs(114, 63).addBox(-4.0F, 14.0F, -4.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0075F)), PartPose.offsetAndRotation(4.25F, -3.75F, 2.25F, 0.3054F, 0.0F, -0.3054F));

		PartDefinition legging_body_dress_front_right = legging_body_dress_front.addOrReplaceChild("legging_body_dress_front_right", CubeListBuilder.create().texOffs(84, 27).addBox(0.0F, 0.0F, -4.0F, 4.0F, 14.0F, 4.0F, new CubeDeformation(0.0075F))
		.texOffs(114, 70).addBox(0.0F, 14.0F, -4.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0075F)), PartPose.offsetAndRotation(-4.25F, -3.75F, 2.25F, 0.3054F, 0.0F, 0.3054F));
		...
		PartDefinition cube_r13 = legging_body_dress_back.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(88, 70).addBox(-4.75F, 14.0F, 0.0F, 9.0F, 3.0F, 4.0F, new CubeDeformation(0.075F))
		.texOffs(0, 58).addBox(-4.75F, 0.0F, 0.0F, 9.0F, 14.0F, 4.0F, new CubeDeformation(0.075F)), PartPose.offsetAndRotation(0.25F, -3.75F, -2.5F, -0.3927F, 0.0F, 0.0F));

		PartDefinition legging_body_dress_back_left = legging_body_dress_back.addOrReplaceChild("legging_body_dress_back_left", CubeListBuilder.create().texOffs(88, 45).addBox(-4.0F, 0.0F, 0.0F, 4.0F, 14.0F, 4.0F, new CubeDeformation(0.0075F))
		.texOffs(116, 8).addBox(-4.0F, 14.0F, 0.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0075F)), PartPose.offsetAndRotation(4.25F, -3.75F, -2.25F, -0.3054F, 0.0F, -0.3054F));

		PartDefinition legging_body_dress_back_right = legging_body_dress_back.addOrReplaceChild("legging_body_dress_back_right", CubeListBuilder.create().texOffs(68, 88).addBox(0.0F, 0.0F, 0.0F, 4.0F, 14.0F, 4.0F, new CubeDeformation(0.0075F))
		.texOffs(116, 15).addBox(0.0F, 14.0F, 0.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0075F)), PartPose.offsetAndRotation(-4.25F, -3.75F, -2.25F, -0.3054F, 0.0F, 0.3054F));

		PartDefinition chestplate_leftarm = chestplate.addOrReplaceChild("chestplate_leftarm", CubeListBuilder.create().texOffs(0, 93).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.255F)), PartPose.offset(-5.0F, 2.0F, 0.0F));
		...
		PartDefinition chestplate_leftarm_shoulderpad = chestplate_leftarm_parts.addOrReplaceChild("chestplate_leftarm_shoulderpad", CubeListBuilder.create().texOffs(50, 60).addBox(0.0F, -2.0F, -4.25F, 2.0F, 9.0F, 8.5F, new CubeDeformation(0.007F)), PartPose.offsetAndRotation(-1.5F, -1.75F, 0.0F, 0.0F, 0.0F, 1.0472F));

		PartDefinition cube_r14 = chestplate_leftarm_shoulderpad.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(96, 109).addBox(-1.0F, -2.5F, -2.5F, 2.0F, 5.0F, 5.0F, new CubeDeformation(0.007F))
		.texOffs(28, 76).addBox(-1.0F, -5.5F, -5.5F, 2.0F, 8.0F, 8.0F, new CubeDeformation(0.007F)), PartPose.offsetAndRotation(-1.0F, 1.5F, 0.0F, -0.7854F, 0.0F, 0.0F));
		...
		PartDefinition chestplate_leftarm_gaunlet = chestplate_leftarm_parts.addOrReplaceChild("chestplate_leftarm_gaunlet", CubeListBuilder.create().texOffs(100, 99).addBox(-0.5F, -6.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.255F)), PartPose.offset(-2.5F, 10.5F, 0.0F));

		PartDefinition chestplate_leftarm_gaunlet_ornament = chestplate_leftarm_gaunlet.addOrReplaceChild("chestplate_leftarm_gaunlet_ornament", CubeListBuilder.create().texOffs(0, 122).addBox(-1.0F, -2.0F, -2.0F, 2.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(100, 9).addBox(-1.0F, -4.0F, -2.0F, 2.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.75F, -1.75F, 0.0F, 0.7854F, 0.0F, 0.0F));

		PartDefinition chestplate_rightarm = chestplate.addOrReplaceChild("chestplate_rightarm", CubeListBuilder.create().texOffs(42, 93).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.255F)), PartPose.offset(5.0F, 2.0F, 0.0F));
		...
		PartDefinition chestplate_rightarm_gaunlet = chestplate_rightarm_parts.addOrReplaceChild("chestplate_rightarm_gaunlet", CubeListBuilder.create().texOffs(104, 45).addBox(-3.5F, -6.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.255F)), PartPose.offset(2.5F, 10.5F, 0.0F));

		PartDefinition chestplate_rightarm_gaunlet_ornament = chestplate_rightarm_gaunlet.addOrReplaceChild("chestplate_rightarm_gaunlet_ornament", CubeListBuilder.create().texOffs(100, 21).addBox(-1.0F, -4.0F, -2.0F, 2.0F, 6.0F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(48, 122).addBox(-1.0F, -2.0F, -2.0F, 2.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.75F, -1.75F, 0.0F, 0.7854F, 0.0F, 0.0F));

		PartDefinition chestplate_rightarm_shoulderpad = chestplate_rightarm_parts.addOrReplaceChild("chestplate_rightarm_shoulderpad", CubeListBuilder.create().texOffs(64, 0).addBox(-2.0F, -2.0F, -4.25F, 2.0F, 9.0F, 8.5F, new CubeDeformation(0.007F)), PartPose.offsetAndRotation(1.5F, -1.75F, 0.0F, 0.0F, 0.0F, -1.0472F));

		PartDefinition cube_r15 = chestplate_rightarm_shoulderpad.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(48, 77).addBox(-1.0F, -5.5F, -5.5F, 2.0F, 8.0F, 8.0F, new CubeDeformation(0.007F))
		.texOffs(20, 110).addBox(-1.0F, -2.5F, -2.5F, 2.0F, 5.0F, 5.0F, new CubeDeformation(0.007F)), PartPose.offsetAndRotation(1.0F, 1.5F, 0.0F, -0.7854F, 0.0F, 0.0F));
